...
if(isset($_POST["submit"])){
    // if (empty($_POST["event_name"]) || empty($_POST["cap"]) || $_POST['end_date'] || $_POST['start_date'] || empty($_POST["loc"]) || empty($_POST["desc"]) || empty($_FILES["gambar"]["name"])){
    //     header("Location: insert.php?error");
    // }  
