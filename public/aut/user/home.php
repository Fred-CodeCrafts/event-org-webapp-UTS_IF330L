...
<body>
    ...
    <div class="mt-32">
        <h1 class="text-center font-bold text-2xl mb-9">Upcoming Events</h1>
        <div class="flex mx-11 justify-center">
            ...
            <div id="alert-3" class="fixed bottom-0 left-0 right-0 z-50 flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
